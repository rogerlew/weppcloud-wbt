...
/// [hyperbolic cosine](https://en.wikipedia.org/wiki/Hyperbolic_function) (cosh) of the corresponding
...
impl Cosh {
    /// public constructor
    pub fn new() -> Cosh {
        let name = "Cosh".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description =
            "Returns the hyperbolic cosine (cosh) of each values in a raster.".to_string();
