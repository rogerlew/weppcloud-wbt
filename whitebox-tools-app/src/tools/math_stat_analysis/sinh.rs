...
/// [hyperbolic sine](https://en.wikipedia.org/wiki/Hyperbolic_function) (sinh) of the corresponding
...
impl Sinh {
    /// public constructor
    pub fn new() -> Sinh {
        let name = "Sinh".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description =
            "Returns the hyperbolic sine (sinh) of each values in a raster.".to_string();
