...
impl ArcCos {
    /// public constructor
    pub fn new() -> ArcCos {
        let name = "ArcCos".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description =
            "Returns the inverse cosine (arccos) of each values in a raster.".to_string();
