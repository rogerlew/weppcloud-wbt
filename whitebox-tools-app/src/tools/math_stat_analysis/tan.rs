...
impl Tan {
    /// public constructor
    pub fn new() -> Tan {
        let name = "Tan".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description = "Returns the tangent (tan) of each values in a raster.".to_string();
