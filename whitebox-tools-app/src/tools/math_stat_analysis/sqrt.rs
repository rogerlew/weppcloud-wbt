...
impl SquareRoot {
    /// public constructor
    pub fn new() -> SquareRoot {
        let name = "SquareRoot".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description = "Returns the square root of the values in a raster.".to_string();
...
impl WhiteboxTool for SquareRoot {
