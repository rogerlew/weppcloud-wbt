...
impl Arsinh {
    /// public constructor
    pub fn new() -> Arsinh {
        let name = "Arsinh".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description =
            "Returns the inverse hyperbolic sine (arsinh) of each values in a raster.".to_string();
