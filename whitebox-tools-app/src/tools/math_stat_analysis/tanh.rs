...
/// [hyperbolic tangent](https://en.wikipedia.org/wiki/Hyperbolic_function) (tanh) of the corresponding
...
impl Tanh {
    /// public constructor
    pub fn new() -> Tanh {
        let name = "Tanh".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description =
            "Returns the hyperbolic tangent (tanh) of each values in a raster.".to_string();
