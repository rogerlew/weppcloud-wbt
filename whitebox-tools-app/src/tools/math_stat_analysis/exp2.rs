...
impl Exp2 {
    /// public constructor
    pub fn new() -> Exp2 {
        let name = "Exp2".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description = "Returns the exponential (base 2) of values in a raster.".to_string();
