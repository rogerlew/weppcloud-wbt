...
impl ArcSin {
    /// public constructor
    pub fn new() -> ArcSin {
        let name = "ArcSin".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description =
            "Returns the inverse sine (arcsin) of each values in a raster.".to_string();
