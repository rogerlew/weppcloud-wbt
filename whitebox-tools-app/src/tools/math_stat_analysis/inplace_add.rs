...
impl InPlaceAdd {
    /// public constructor
    pub fn new() -> InPlaceAdd {
        let name = "InPlaceAdd".to_string();
        let toolbox = "Math and Stats Tools".to_string();
        let description = "Performs an in-place addition operation (input1 += input2).".to_string();
...
impl WhiteboxTool for InPlaceAdd {
