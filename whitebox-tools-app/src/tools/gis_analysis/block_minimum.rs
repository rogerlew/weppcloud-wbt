...
pub struct BlockMinimumGridding {
    name: String,
    description: String,
    toolbox: String,
...
impl BlockMinimumGridding {
    /// public constructor
    pub fn new() -> BlockMinimumGridding {
        let name = "BlockMinimumGridding".to_string();
        let toolbox = "GIS Analysis".to_string();
        let description = "Creates a raster grid based on a set of vector points and assigns grid values using a block minimum scheme.".to_string();
...
impl WhiteboxTool for BlockMinimumGridding {
