...
/// This tool calculates the percentage of a raster stack (`--inputs`) that have cell values equal to an input *comparison*
...
///
/// # See Also
/// `PercentGreaterThan`, `PercentLessThan`
pub struct PercentEqualTo {
    name: String,
    description: String,
    toolbox: String,
...
impl PercentEqualTo {
    pub fn new() -> PercentEqualTo {
        // public constructor
        let name = "PercentEqualTo".to_string();
        let toolbox = "GIS Analysis/Overlay Tools".to_string();
        let description = "Calculates the percentage of a raster stack that have cell values equal to an input on a cell-by-cell basis.".to_string();
...
impl WhiteboxTool for PercentEqualTo {
