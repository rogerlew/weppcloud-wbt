...
mod deviation_from_regional_direction;
mod difference;
mod dissolve;
mod edge_proportion;
...
pub use self::clip_raster_to_raster::ClipRasterToRaster;
...
pub use self::deviation_from_regional_direction::DeviationFromRegionalDirection;
