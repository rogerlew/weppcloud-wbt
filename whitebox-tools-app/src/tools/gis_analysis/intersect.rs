...
impl WhiteboxTool for Intersect {
    ...
    fn run<'a>(
        ...
        match input.header.shape_type.base_shape_type() {
            ...
            ShapeType::MultiPoint => {
                ...
                // now see which ones overlap
                let mut output_point = vec![false; total_points];
                ...
                for record_num in 0..input.num_records {
                    ...
                    for i in 0..record.points.len() {
                        ...
                        if verbose {
                            progress = (100.0_f64 * i as f64 / (total_points - 1) as f64) as usize;
                            if progress != old_progress {
                                println!("Progress: {}%", progress);
                                old_progress = progress;
                            }
