...
impl FindNoFlowCells {
    pub fn new() -> FindNoFlowCells {
        // public constructor
        let name = "FindNoFlowCells".to_string();
        let toolbox = "Hydrological Analysis".to_string();
        let description = "Finds grid cells with no downslope neighbours.".to_string();
...
impl WhiteboxTool for FindNoFlowCells {
    ...
    fn run<'a>(
        ...
        for tid in 0..num_procs {
            ...
            thread::spawn(move || {
                let mut z: f64;
                let mut zn: f64;
                let mut has_no_lower_neighbour: f64;
                ...
                for row in (0..rows).filter(|r| r % num_procs == tid) {
                    ...
                    for col in 0..columns {
                        ...
                        if z != nodata {
                            ...
                            data[col as usize] = has_no_lower_neighbour;
                        }
                    }
