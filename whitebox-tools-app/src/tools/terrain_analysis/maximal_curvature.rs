...
/// This tool calculates the maximal curvature from a digital elevation model (DEM). Maximal curvature
/// is the curvature of a principal section with the highest value of curvature at a given point of the
/// topographic surface (Florinsky, 2017). The values of this curvature are unbounded, and positive
/// values correspond to ridge positions while negative values are indicative of closed depressions
/// (Florinsky, 2016). Maximal curvature is measured in units of m<sup>-1</sup>.
///
/// ![](../../doc_img/MaximalCurvature.png)
///
                            ...
                            if z12 != nodata {
                                ...
                                */
                                ...
                                if log_transform {
                                    ...
                                    maximal_curv = maximal_curv.signum()
                                        * (1. + log_multiplier * maximal_curv.abs()).ln();
                                }
