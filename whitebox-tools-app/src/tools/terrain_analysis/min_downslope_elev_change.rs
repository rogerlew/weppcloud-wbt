...
impl MinDownslopeElevChange {
    pub fn new() -> MinDownslopeElevChange {
        // public constructor
        let name = "MinDownslopeElevChange".to_string();
        let toolbox = "Geomorphometric Analysis".to_string();
        let description = "Calculates the minimum downslope change in elevation between a grid cell and its eight downslope neighbors."
            .to_string();
...
impl WhiteboxTool for MinDownslopeElevChange {
    ...
    fn run<'a>(
        ...
        for tid in 0..num_procs {
            ...
            thread::spawn(move || {
                let mut z: f64;
                let mut zn: f64;
                let mut min_slope: f64;
                let mut slope: f64;
                let mut dist: f64;
                let mut min_z_change: f64;
                ...
                for row in (0..rows).filter(|r| r % num_procs == tid) {
                    ...
                    for col in 0..columns {
                        ...
                        if z != nodata {
                            ...
                            if min_slope < f64::INFINITY {
                                data[col as usize] = min_z_change;
                            } else {
