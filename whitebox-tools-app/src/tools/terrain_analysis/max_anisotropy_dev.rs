...
impl WhiteboxTool for MaxAnisotropyDev {
    ...
    fn run<'a>(
        ...
        let num_loops = (min_scale..max_scale + 1).fold(0, |acc, x| {
            if (x - min_scale) % step == 0 {
                acc + 1
            } else {
                acc
            }
                                        ...
                                        if n > 3 {
                                            ...
                                            if v > 0f64 {
                                                ...
                                                if num_panes_valid > 0f64 {
                                                    ...
                                                    data[col as usize] = ((values[1] * values[1]
                                                        + values[2] * values[2]
                                                        + values[3] * values[3]
                                                        + values[4] * values[4])
                                                        / num_panes_valid)
