...
impl TributaryIdentifier {
    pub fn new() -> TributaryIdentifier {
        // public constructor
        let name = "TributaryIdentifier".to_string();
        let toolbox = "Stream Network Analysis".to_string();
        let description =
            "Assigns a unique identifier to each tributary in a stream network.".to_string();
...
impl WhiteboxTool for TributaryIdentifier {
