...
impl ToolManager {
    pub fn new<'a>(
        ...
        tool_names.push("StaleySlopeSbs".to_string());
        ...
        tool_names.push("FVSlope".to_string());
        ...
        tool_names.push("PruneStrahlerStreamOrder".to_string());
        ...
        tool_names.push("RusleLsFactor".to_string());
    ...
    fn get_tool(&self, tool_name: &str) -> Option<Box<dyn WhiteboxTool + 'static>> {
        match tool_name.to_lowercase().replace("_", "").as_ref() {
            ...
            "staleyslopesbs" => Some(Box::new(hydro_analysis::StaleySlopeSbs::new())),
            ...
            "fvslope" => Some(Box::new(hydro_analysis::FVSlope::new())),
            ...
            "ruslelsfactor" => Some(Box::new(terrain_analysis::RusleLsFactor::new())),
