...
| WP-04 | Phase B First-Order-Link Pruning (Parity Path) | backlog | TBD | WP-03 | pending | pending | n/a | n/a |  |  |  | Active ExecPlan: `/workdir/wepppy/docs/work-packages/20260413_ifolp_wp04_first_order_link_pruning/prompts/active/ifolp_wp04_first_order_link_pruning_execplan.md` |
