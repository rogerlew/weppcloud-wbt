...
| WP-05 | TopAZ Parity Validation Package | backlog | TBD | WP-04 | pending | pending | pending | n/a |  |  |  | Active ExecPlan: `/workdir/wepppy/docs/work-packages/20260413_ifolp_wp05_topaz_parity_validation/prompts/active/ifolp_wp05_topaz_parity_validation_execplan.md` |
